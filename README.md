...
- **MODES**: This fork includes extra synchronous AM demodulation modes, selectable from the keyboard. While most modes are automatically set, based on frequency, you use **SHIFT + A** to engage the synchronous double sideband demodulator, **SHIFT + U** for synchronous upper sideband, and **SHIFT + L** for synchronous lower sideband. Revert to conventional AM, USB, or LSB with **A**, **U**, or **L**, respectively.
